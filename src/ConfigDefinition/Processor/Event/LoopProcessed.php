...
class LoopProcessed implements EventInterface
{
    public const MESSAGE_NAME = 'loop-processed';
    ...
    public function __construct(LoopDefinition $definition, Person $person)
    {
