...
final class AMT extends MapSegment
{
    public function __construct()
    {
        ...
        $content->append(DE\E_0522::createWithRequirementDesignator(RequirementDesignator::Mandatory()));
        $content->append(DE\E_0782::createWithRequirementDesignator(RequirementDesignator::Mandatory()));
        $content->append(DE\E_0478::createWithRequirementDesignator(RequirementDesignator::Optional()));
    }
}
