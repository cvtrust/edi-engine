...
final class AD1 extends MapSegment
{
    public function __construct()
    {
        ...
        $content->append(DE\E_0426::createWithRequirementDesignator(RequirementDesignator::Mandatory()));
        $content->append(DE\E_0782::createWithRequirementDesignator(RequirementDesignator::Optional()));
        $content->append(DE\E_1129::createWithRequirementDesignator(RequirementDesignator::Optional()));
        $content->append(DE\E_0594::createWithRequirementDesignator(RequirementDesignator::Optional()));
        $content->append(DE\E_0009::createWithRequirementDesignator(RequirementDesignator::Optional()));
    }
}
